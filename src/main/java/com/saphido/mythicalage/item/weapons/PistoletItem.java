package com.saphido.mythicalage.item.weapons;

import java.util.List;
import java.util.function.Consumer;

import com.saphido.mythicalage.MythicalAgeMod;
import com.saphido.mythicalage.client.renderer.item.PistoletRenderer;
...
public class PistoletItem extends Item implements IAnimatable, ISyncable {
	...
	public PistoletItem() {
		super(new Item.Properties().tab(MythicalAgeMod.mythicalageItemGroup).stacksTo(1).durability(201));
	...
	public void initializeClient(Consumer<IItemRenderProperties> consumer) {
		...
		consumer.accept(new IItemRenderProperties() {
			private final BlockEntityWithoutLevelRenderer renderer = new PistoletRenderer();
