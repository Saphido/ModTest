package com.saphido.mythicalage.item;

import java.util.function.Consumer;

import com.saphido.mythicalage.MythicalAgeMod;
import com.saphido.mythicalage.client.renderer.item.JackTheBoxRenderer;
...
public class JackTheBoxItem extends Item implements IAnimatable, ISyncable {
	private static final String CONTROLLER_NAME = "popupController";
	private static final int ANIM_OPEN = 0;
	public AnimationFactory factory = new AnimationFactory(this);

	public JackTheBoxItem(Properties properties) {
		super(properties.tab(MythicalAgeMod.mythicalageItemGroup));
	...
	public void initializeClient(Consumer<IItemRenderProperties> consumer) {
		...
		consumer.accept(new IItemRenderProperties() {
			private final BlockEntityWithoutLevelRenderer renderer = new JackTheBoxRenderer();
