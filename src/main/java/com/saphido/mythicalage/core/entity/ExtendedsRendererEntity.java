...
public class ExtendedsRendererEntity extends PathfinderMob implements IAnimatable {

	
	private AnimationFactory factory = new AnimationFactory(this);

	public ExtendedsRendererEntity(EntityType<? extends PathfinderMob> p_i48575_1_, Level p_i48575_2_) {
