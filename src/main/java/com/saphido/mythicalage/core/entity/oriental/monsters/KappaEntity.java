...
public class KappaEntity extends Monster implements IAnimatable, IAnimationTickable {
	...
	public KappaEntity(EntityType<? extends Monster> type, Level worldIn) {
		super(type, worldIn);
		this.noCulling = true;
	}
	...
	public void registerControllers(AnimationData data) {
		AnimationController<KappaEntity> controller = new AnimationController<>(this, "controller", 0, this::predicate);
