...
public class YukiOnnaEntity extends Monster implements IAnimatable, IAnimationTickable {
	private AnimationFactory factory = new AnimationFactory(this);
	private static final ResourceLocation LOOT_TABLE = new ResourceLocation(MythicalAgeMod.ModID, "entities/yuki_onna_entity");
	...
	public YukiOnnaEntity(EntityType<? extends Monster> type, Level worldIn) {
		super(type, worldIn);
		this.noCulling = true;
	}
	...
	public void registerControllers(AnimationData data) {
		AnimationController<YukiOnnaEntity> controller = new AnimationController<>(this, "controller", 0, this::predicate);
