...
public class OniEntity extends Monster implements IAnimatable, IAnimationTickable {
	...
	public OniEntity(EntityType<? extends Monster> type, Level worldIn) {
		super(type, worldIn);
		this.noCulling = true;
	}
	...
	public void registerControllers(AnimationData data) {
		AnimationController<OniEntity> controller = new AnimationController<>(this, "controller", 0, this::predicate);
